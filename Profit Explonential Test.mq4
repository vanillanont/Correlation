...
{ 
   ...
   for(int i = 0; i< Size_Group; i++){
      ...
      if(ObjectFind(lbl_Symbol_First) < 0){  
         ...
         ObjectSetString(0,lbl_Main_Lot,OBJPROP_TOOLTIP,IntegerToString(Order_MainSpace));  
         ...
         ObjectSetString(0,lbl_Hedge_Lot,OBJPROP_TOOLTIP,IntegerToString(Order_HedgeSpace));  
